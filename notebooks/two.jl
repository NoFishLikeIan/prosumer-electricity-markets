...
using DataFrames, LinearAlgebra, Distributions, Cairo, Compose

# ╔═╡ 7550b8f6-b3f6-4f44-a36b-6f7fa483351b
using LightGraphs, Agents

# ╔═╡ 321f5b93-604c-4ad0-b41c-345cfbfa4f2f
using Plots, GraphPlot, LaTeXStrings, StatsPlots

# ╔═╡ 5f311107-67b1-4009-9de1-1883db408e2b
using DotEnv,JLD
...
begin
	...
	default(size = (800*3/2, 600), margin = 10Plots.mm)
...
begin
	model = initializemodel(A, G, default_params; εpath = makeshock(200, 230))
	fulldfagent, fulldfmodel = simulatemarket!(model; T = T)
	
	dfagent = fulldfagent[fulldfagent.step .≥ 0, :]
	dfmodel = fulldfmodel[fulldfmodel.step .≥ 0, :]
...
[[Agents]]
deps = ["DataFrames", "Distributed", "LightGraphs", "LinearAlgebra", "OpenStreetMapX", "Random", "StatsBase"]
git-tree-sha1 = "3f92f44a7cea93b758da662707d59d670193ba3f"
...
[[OpenStreetMapX]]
deps = ["DataStructures", "HTTP", "JSON", "LibExpat", "LightGraphs", "Random", "Serialization", "SparseArrays", "Statistics"]
git-tree-sha1 = "71fe65bce368557f5b94079ac709a9c08f46f720"
