...
\begin{equation}
    J_{\psi}(s, p, r) = s \cdot p - c(s, r) \cdot r + \beta \cdot V(s + r, \psi \cdot p)
\end{equation}
...
\begin{equation}
    \begin{split}
        \frac{\partial V}{\partial s}(s, p) &= p - \frac{\partial c}{\partial s}(s, r) \cdot r + \beta \cdot \frac{\partial V}{\partial s}(s + r, \psi \cdot p)
    \end{split}
\end{equation}
...
\begin{equation}
    \begin{split}
        \frac{\partial V}{\partial s}(s, p) &= p - \frac{\partial c}{\partial s}(s, r) \cdot r + \frac{\partial c}{\partial r}(s, r) \cdot r + c(s, r) \\
        &= p + \left[\frac{\partial c}{\partial r}(s, r) - \frac{\partial c}{\partial s}(s, r)\right] \cdot r + c(s, r)
    \end{split}
\end{equation}
...
\begin{equation}
    \frac{\partial V}{\partial s}(s + r, \psi \cdot p)  = \psi \cdot p + \left[\frac{\partial c}{\partial r}(s + r, r) - \frac{\partial c}{\partial s}(s + r, r)\right] \cdot r + c(s + r, r)
\end{equation}
...
Let the cost function be $c(s, r) = \log(1 + \exp(c_1 \cdot s\cdot r + c_0))$, then Equation (\ref{raw_policy_producer}) can be rewritten as,

\begin{equation*}
    \begin{split}
        \frac{\mathcal{S}_c(s, r) \cdot s \cdot r + c(s, r)}{\beta} &= \psi \cdot p + \left[ \mathcal{S}_c(s + r, r) \cdot (s + r)  - \mathcal{S}_c(s + r, r) \cdot r \right] \cdot r + c(s + r, r) \\
        \frac{\mathcal{S}_c(s, r) \cdot s \cdot r + c(s, r)}{\beta} &= \psi \cdot p +\mathcal{S}_c(s + r, r) \cdot s \cdot r + c(s + r, r)
    \end{split}
\end{equation*}
...
\begin{equation}
    \begin{split}
        ...
        p_{t+1} &= p_t + \frac{b}{a} +  \left( \frac{1 - \beta}{\beta} \right) \cdot \frac{X_t}{N \cdot a} - \lambda_{t+1}
    \end{split}
\end{equation}
