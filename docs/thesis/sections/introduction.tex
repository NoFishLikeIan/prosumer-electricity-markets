...
In this paper I layout a stylized model of a decentralized electricity market with trading providers and local prosumers. A significant presence of prosumers in the electricity market induces uncertainty via two avenues. First, prosumers with bounded rationality in their forecasting procedure and risk aversion overcompensate shocks both in production and consumption. Second, renewable energy production takes the form of a volatile endowment. The model is used to investigate the consequence of this added instability for prices in the wholesale cross-border daily electricity market, both in presence and absence of ``traditional'' energy producers. Then it is used to assess the current strategy in the EU and the USA of further integration of electricity grids and competition in the providers market, with the aim of inducing price stability.
...
I will rather focus on giving a theoretical foundation to some key facts that have been observed as renewable energy uptake and prosumers have become more widespread. Such a model augments the vast econometric analysis that has been done on these phenomena, for example \citein{Gebhardt2013} or \citein{Newbery2016}. To do so, first I will improve on the commonly used constant electricity demand (\cite{Weidlich2008}) by introducing bounded rational prosumers, with adapting forecasting rules (\cite{Hommes2013}). Second, I will model cross-border trade as a result of a bargaining procedure on a network (\cite{Bedayo2016}).
