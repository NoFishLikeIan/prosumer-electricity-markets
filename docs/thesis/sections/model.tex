...
\begin{equation} \label{raw_policy_producer}
    \begin{split}
        &r(s_t, p_t; \psi): \\
        \frac{\partial c}{\partial r}(s_t, r) \cdot r + c(s_t, r) &= \beta \cdot \left\{  \psi \cdot p_t + \left[\frac{\partial c}{\partial r}(s_t + r, r) - \frac{\partial c}{\partial s_t}(s_t + r, r)\right] \cdot r + c(s_t + r, r) \right\} \\
...
\begin{equation}
    \begin{split}
        mc(r; s_t, p_t, \psi) &= 2r \\
        mb(r; s_t, p_t, \psi) &= \psi \cdot p_t + 2r
    \end{split}
\end{equation}
...
\begin{equation}
    r(s_t, p_t; \psi) = \frac{\beta}{1 - \beta} \cdot \frac{\psi}{2} \cdot p_t
\end{equation}
...
\begin{equation}
    \begin{split}
        ...
        u_{t+1} &= s_{t+1} \cdot p_{t+1} - c(s_{t+1}, r_{t+1}) \cdot r(s_{t+1}, p_{t+1}; \psi_{t})
    \end{split}
\end{equation}
