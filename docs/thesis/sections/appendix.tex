...
First, we can get rid of the Hadamard division by letting, $\matr{D}_{Y} \coloneqq \diag(\Y_t)$ and $\matr{D}_{X} \coloneqq \diag(\matr{\Delta })$, such that,
...
\begin{equation}
    \begin{split}
        ...
        &= - (2\matr{I} + \matr{G})^{-1} \matr{D}_X \matr{D}_Y^{-2} d \Y_t
    \end{split}
\end{equation}
...
\begin{equation}
    \begin{split}
        \mathbb{J}\{P\}(\Y_t) &= - (2\matr{I} + \matr{G})^{-1} \matr{D}_X \matr{D}_Y^{-2} \\
        &= - (2\matr{I} + \matr{G})^{-1} \diag (\Delta _t \oslash \Y^2_t)
    \end{split}
\end{equation}
...
\begin{equation}
    \begin{split}
        ...
        \end{pmatrix} &+\begin{pmatrix}
            \mathbb{J}\{P\}^{(1, 2)}_{(1, 2)} & \mathbb{J}\{P\}^{(1, 3)}_{(1, 2)} & \ldots \\
            \mathbb{J}\{P\}^{(1, 2)}_{(1, 3)} & \ddots                            &        \\
            \vdots                            &                                   &        \\
        \end{pmatrix} \begin{pmatrix}
            1      & 0 & \ldots \\
            1      & 1 &        \\
