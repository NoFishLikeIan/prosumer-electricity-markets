...
Looking for stability. Assume the demand is locally satisfied,

\begin{equation}
    M \cdot e_t = S_t: X_t = 0
\end{equation}

Furthermore, assume we are in an equilibrium $p_t = p_{t+1}$ and $p_t = k \implies r(s_{i, t}, p_t) = 0$. The first equation implies that,
