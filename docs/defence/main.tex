...
\begin{frame}{ABM: \citeauthor{Weidlich2008} (\citeyear{Weidlich2008})}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{.6\textwidth}
            \centering
            \resizebox{0.7\textwidth}{!}{\input{diagrams/previous.tikz}}
        \end{column}
    \end{columns}
...
\begin{frame}{Looking at $P$ as a whole}
    ...
    \begin{equation*}
        L\Big(  \resizebox{0.3\linewidth}{!}{\input{diagrams/originalg.tikz}} \Big) = \resizebox{0.3\linewidth}{!}{\input{diagrams/lineg.tikz}}
    \end{equation*}
\end{frame}
...
\begin{frame}{Path}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{.46\textwidth}
            \resizebox{\linewidth}{!}{\input{\outdiag/line.tikz}}
        \end{column}

        \hfill

        \begin{column}{.46\textwidth}
            \resizebox{\linewidth}{!}{\input{diagrams/assocpath.tikz}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame} {Bargaining influence matrix: $(2\I + \G)^{-1}$ }
    ...
    \begin{figure}
        \centering
        \includegraphics[width = 0.5\linewidth]{../../plots/bargmatrices/color.pdf}
    \end{figure}
...
\begin{frame} {Policy function $p_{t+1}$ of the central node}
    ...
    \begin{figure}
        \centering
        \includegraphics[width = 0.5 \linewidth]{../../plots/colors.pdf}
    \end{figure}
...
\begin{frame}[allowframebreaks]{More path, less star}
    ...
    \centering
    \resizebox{0.7\textwidth}{!}{\input{diagrams/rho.tikz}}
