...
Because of this limitation, here I will limit the analysis to acyclical (or complete) graphs. Extending this model to cyclical graphs simply requires defining a more general once differentiable function $P: \R^{\abs{E}} \mapsto \R^{\abs{E}}$ that models the bargaining procedure.
