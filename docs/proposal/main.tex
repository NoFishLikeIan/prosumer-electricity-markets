...
% TODO: Check opportunities and challenges for...
% FIXME: Talk about how the non-linearities are introduced
...
Given the structure of the model, the goal is to derive a law of motion (i.e. non-linear difference equation) for electricity production and analyze its dynamical properties. In particular the focus will be on finding, given a network structure, the combination of parameter space and pricing mechanism that yields the optimal resilience, as defined above.
...
% TODO: Clarify connection: model -> trophic analysis -> resilience 
